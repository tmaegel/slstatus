...
#define RSSI_TO_PERC(rssi) \
    ...
    static const char *d_dots(unsigned char q) {
        const char *s[] = {
            "^c#4b555a^^r0,17,4,3^^f5^^r0,14,4,6^^f5^^r0,11,4,9^^f5^^r0,8,4,12^^f6^^c#8b9499^",//  0-25%
            "^r0,17,4,3^^f5^^c#4b555a^^r0,14,4,6^^f5^^r0,11,4,9^^f5^^r0,8,4,12^^f6^^c#8b9499^",// 25-50%
            "^r0,17,4,3^^f5^^r0,14,4,6^^f5^^c#4b555a^^r0,11,4,9^^f5^^r0,8,4,12^^f6^^c#8b9499^",// 50-75%
            "^r0,17,4,3^^f5^^r0,14,4,6^^f5^^r0,11,4,9^^f5^^c#4b555a^^r0,8,4,12^^f6^^c#8b9499^",// 75-99%
            "^r0,17,4,3^^f5^^r0,14,4,6^^f5^^r0,11,4,9^^f5^^r0,8,4,12^^f6^"                     //   100%
        };
